...
@Database(entities = [WorkoutDayEntity::class], version = 12, exportSchema = false)
abstract class AppDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        // v11 → v12: add "customMinutes" for Cardio customs logged by time rather than
        // distance (an elliptical, a class) — "" = none logged.
        private val MIGRATION_11_12 = object : Migration(11, 12) {
            override fun migrate(db: SupportSQLiteDatabase) {
                db.execSQL("ALTER TABLE workout_day ADD COLUMN customMinutes TEXT NOT NULL DEFAULT ''")
            }
        }
