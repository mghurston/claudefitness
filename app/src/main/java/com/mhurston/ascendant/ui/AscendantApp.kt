    ...
    Scaffold(
        ...
        when (tabs[tab]) {
            Tab.DASHBOARD -> DashboardScreen(
                ...
                onAddCustomDistance = vm::addCustomDistanceToday,
                onAddCustomMinutes = vm::addCustomMinutesToday,
                onSetCustomCardio = vm::setCustomExerciseCardio,
            ...
            Tab.HISTORY -> CalendarScreen(
                ...
                onAddCustomDistance = vm::addCustomDistanceForDate,
                onAddCustomMinutes = vm::addCustomMinutesForDate,
                onAddCustomExercise = vm::addCustomExercise,
